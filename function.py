...
def class_model(model, X_train, X_test, y_train, y_test):
    ...
    print('Classification report for training data:', classification_report(y_train, y_pred_train))
    print('Classification report for testing data:', classification_report(y_test, y_pred_test))
